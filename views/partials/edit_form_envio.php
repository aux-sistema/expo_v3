<div class="row g-4">
    ...
    <div class="col-md-4 form-floating">
        ...
        <label for="noCliente">Número de dsCliente</label>
    </div>
    ...
    <div class="form-check form-switch mt-4">
        <input class="form-check-input" type="checkbox" id="facturaSwitch" name="requiere_factura" 
            <?php echo $requiereFactura ? 'checked' : ''; ?>readonly>
    ...
    <div id="facturaForm" style="display: <?php echo $requiereFactura ? 'block' : 'none'; ?>;"readonly>
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6 form-floating">
                <select name="uso_cfdi" class="form-select" id="usoCFDI">
                    <option value="">Seleccione Uso de CFDI</option readonly>
